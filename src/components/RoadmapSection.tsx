...
const RoadmapSection = () => {
  return (
    <section id="roadmap" className="py-20 bg-gradient-to-b from-chess-dark to-chess-dark/95">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-lg text-foreground/80 max-w-3xl mx-auto leading-relaxed">
            Follow our structured path from complete beginner to advanced player. Each level builds upon the previous,
            ensuring you develop a solid foundation before moving to more complex concepts.
          </p>
        </div>
          ...
          <div className="bg-white/5 backdrop-blur border border-white/10 rounded-2xl p-8 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button 
                ...
                className="bg-transparent border border-white/20 text-foreground hover:bg-white/10 font-semibold px-6 py-3 rounded-lg transition-all"
              >
                Learn More
              </button>
            </div>
